...
- Lockfile: `apps/desktop/src-tauri/Cargo.lock`, canonical LF SHA-256 `0eb6f926e9a2ee05249f61c9ae89cc8e0da2b7b306455d42560629429a8a541c`,
  441 packages. The v1.1.2 release preparation changed only the root package version; the
